...
namespace OrderCloud.SDK
{
	...
	public class AddressesResource : OrderCloudResource, IAddressesResource
	{
		...
		public Task<Address<Txp>> GetAsync<Txp>(string buyerID, string addressID, string accessToken = null) => Request("v1", "buyers", buyerID, "addresses", addressID).GetJsonAsync<Address<Txp>>();
		...
		public Task<ListPage<Address<Txp>>> ListAsync<Txp>(string buyerID, string search = null, string searchOn = null, string sortBy = null, int page = 1, int pageSize = 20, object filters = null, string accessToken = null) => Request("v1", "buyers", buyerID, "addresses").SetQueryParams(new { search, searchOn, sortBy, page, pageSize }).SetQueryParams(filters).GetJsonAsync<ListPage<Address<Txp>>>();
		...
		public Task<Address<Txp>> CreateAsync<Txp>(string buyerID, Address address, string accessToken = null) => Request("v1", "buyers", buyerID, "addresses").PostJsonAsync(ValidateModel(address)).ReceiveJson<Address<Txp>>();
		...
		public Task<Address<Txp>> SaveAsync<Txp>(string buyerID, string addressID, Address address, string accessToken = null) => Request("v1", "buyers", buyerID, "addresses", addressID).PutJsonAsync(ValidateModel(address)).ReceiveJson<Address<Txp>>();
		...
		public Task<Address<Txp>> PatchAsync<Txp>(string buyerID, string addressID, PartialAddress partialAddress, string accessToken = null) => Request("v1", "buyers", buyerID, "addresses", addressID).PatchJsonAsync(ValidateModel(partialAddress)).ReceiveJson<Address<Txp>>();
	...
	public class AdminAddressesResource : OrderCloudResource, IAdminAddressesResource
	{
		...
		public Task<Address<Txp>> GetAsync<Txp>(string addressID, string accessToken = null) => Request("v1", "addresses", addressID).GetJsonAsync<Address<Txp>>();
		...
		public Task<ListPage<Address<Txp>>> ListAsync<Txp>(string search = null, string searchOn = null, string sortBy = null, int page = 1, int pageSize = 20, object filters = null, string accessToken = null) => Request("v1", "addresses").SetQueryParams(new { search, searchOn, sortBy, page, pageSize }).SetQueryParams(filters).GetJsonAsync<ListPage<Address<Txp>>>();
		...
		public Task<Address<Txp>> CreateAsync<Txp>(Address address, string accessToken = null) => Request("v1", "addresses").PostJsonAsync(ValidateModel(address)).ReceiveJson<Address<Txp>>();
		...
		public Task<Address<Txp>> SaveAsync<Txp>(string addressID, Address address, string accessToken = null) => Request("v1", "addresses", addressID).PutJsonAsync(ValidateModel(address)).ReceiveJson<Address<Txp>>();
		...
		public Task<Address<Txp>> PatchAsync<Txp>(string addressID, PartialAddress partialAddress, string accessToken = null) => Request("v1", "addresses", addressID).PatchJsonAsync(ValidateModel(partialAddress)).ReceiveJson<Address<Txp>>();
	}
	...
	public class AdminUserGroupsResource : OrderCloudResource, IAdminUserGroupsResource
	{
		...
		public Task<UserGroup<Txp>> GetAsync<Txp>(string userGroupID, string accessToken = null) => Request("v1", "usergroups", userGroupID).GetJsonAsync<UserGroup<Txp>>();
		...
		public Task<ListPage<UserGroup<Txp>>> ListAsync<Txp>(string search = null, string searchOn = null, string sortBy = null, int page = 1, int pageSize = 20, object filters = null, string accessToken = null) => Request("v1", "usergroups").SetQueryParams(new { search, searchOn, sortBy, page, pageSize }).SetQueryParams(filters).GetJsonAsync<ListPage<UserGroup<Txp>>>();
		...
		public Task<UserGroup<Txp>> CreateAsync<Txp>(UserGroup userGroup, string accessToken = null) => Request("v1", "usergroups").PostJsonAsync(ValidateModel(userGroup)).ReceiveJson<UserGroup<Txp>>();
		...
		public Task<UserGroup<Txp>> SaveAsync<Txp>(string userGroupID, UserGroup userGroup, string accessToken = null) => Request("v1", "usergroups", userGroupID).PutJsonAsync(ValidateModel(userGroup)).ReceiveJson<UserGroup<Txp>>();
		...
		public Task<UserGroup<Txp>> PatchAsync<Txp>(string userGroupID, PartialUserGroup partialUserGroup, string accessToken = null) => Request("v1", "usergroups", userGroupID).PatchJsonAsync(ValidateModel(partialUserGroup)).ReceiveJson<UserGroup<Txp>>();
	...
	public class AdminUsersResource : OrderCloudResource, IAdminUsersResource
	{
		...
		public Task<User<Txp>> GetAsync<Txp>(string userID, string accessToken = null) => Request("v1", "adminusers", userID).GetJsonAsync<User<Txp>>();
		...
		public Task<ListPage<User<Txp>>> ListAsync<Txp>(string search = null, string searchOn = null, string sortBy = null, int page = 1, int pageSize = 20, object filters = null, string accessToken = null) => Request("v1", "adminusers").SetQueryParams(new { search, searchOn, sortBy, page, pageSize }).SetQueryParams(filters).GetJsonAsync<ListPage<User<Txp>>>();
		...
		public Task<User<Txp>> CreateAsync<Txp>(User user, string accessToken = null) => Request("v1", "adminusers").PostJsonAsync(ValidateModel(user)).ReceiveJson<User<Txp>>();
		...
		public Task<User<Txp>> SaveAsync<Txp>(string userID, User user, string accessToken = null) => Request("v1", "adminusers", userID).PutJsonAsync(ValidateModel(user)).ReceiveJson<User<Txp>>();
		...
		public Task<User<Txp>> PatchAsync<Txp>(string userID, PartialUser partialUser, string accessToken = null) => Request("v1", "adminusers", userID).PatchJsonAsync(ValidateModel(partialUser)).ReceiveJson<User<Txp>>();
	}
	...
	public class ApprovalRulesResource : OrderCloudResource, IApprovalRulesResource
	{
		...
		public Task<ApprovalRule<Txp>> GetAsync<Txp>(string buyerID, string approvalRuleID, string accessToken = null) => Request("v1", "buyers", buyerID, "approvalrules", approvalRuleID).GetJsonAsync<ApprovalRule<Txp>>();
		...
		public Task<ListPage<ApprovalRule<Txp>>> ListAsync<Txp>(string buyerID, string search = null, string searchOn = null, string sortBy = null, int page = 1, int pageSize = 20, object filters = null, string accessToken = null) => Request("v1", "buyers", buyerID, "approvalrules").SetQueryParams(new { search, searchOn, sortBy, page, pageSize }).SetQueryParams(filters).GetJsonAsync<ListPage<ApprovalRule<Txp>>>();
		...
		public Task<ApprovalRule<Txp>> CreateAsync<Txp>(string buyerID, ApprovalRule approvalRule, string accessToken = null) => Request("v1", "buyers", buyerID, "approvalrules").PostJsonAsync(ValidateModel(approvalRule)).ReceiveJson<ApprovalRule<Txp>>();
		...
		public Task<ApprovalRule<Txp>> SaveAsync<Txp>(string buyerID, string approvalRuleID, ApprovalRule approvalRule, string accessToken = null) => Request("v1", "buyers", buyerID, "approvalrules", approvalRuleID).PutJsonAsync(ValidateModel(approvalRule)).ReceiveJson<ApprovalRule<Txp>>();
		...
		public Task<ApprovalRule<Txp>> PatchAsync<Txp>(string buyerID, string approvalRuleID, PartialApprovalRule partialApprovalRule, string accessToken = null) => Request("v1", "buyers", buyerID, "approvalrules", approvalRuleID).PatchJsonAsync(ValidateModel(partialApprovalRule)).ReceiveJson<ApprovalRule<Txp>>();
	}
	...
	public class BuyersResource : OrderCloudResource, IBuyersResource
	{
		...
		public Task<Buyer<Txp>> GetAsync<Txp>(string buyerID, string accessToken = null) => Request("v1", "buyers", buyerID).GetJsonAsync<Buyer<Txp>>();
		...
		public Task<ListPage<Buyer<Txp>>> ListAsync<Txp>(string search = null, string searchOn = null, string sortBy = null, int page = 1, int pageSize = 20, object filters = null, string accessToken = null) => Request("v1", "buyers").SetQueryParams(new { search, searchOn, sortBy, page, pageSize }).SetQueryParams(filters).GetJsonAsync<ListPage<Buyer<Txp>>>();
		...
		public Task<Buyer<Txp>> CreateAsync<Txp>(Buyer buyer, string accessToken = null) => Request("v1", "buyers").PostJsonAsync(ValidateModel(buyer)).ReceiveJson<Buyer<Txp>>();
		...
		public Task<Buyer<Txp>> SaveAsync<Txp>(string buyerID, Buyer buyer, string accessToken = null) => Request("v1", "buyers", buyerID).PutJsonAsync(ValidateModel(buyer)).ReceiveJson<Buyer<Txp>>();
		...
		public Task<Buyer<Txp>> PatchAsync<Txp>(string buyerID, PartialBuyer partialBuyer, string accessToken = null) => Request("v1", "buyers", buyerID).PatchJsonAsync(ValidateModel(partialBuyer)).ReceiveJson<Buyer<Txp>>();
	}
	...
	public class CatalogsResource : OrderCloudResource, ICatalogsResource
	{
		...
		public Task<Catalog<Txp>> GetAsync<Txp>(string catalogID, string accessToken = null) => Request("v1", "catalogs", catalogID).GetJsonAsync<Catalog<Txp>>();
		...
		public Task<ListPage<Catalog<Txp>>> ListAsync<Txp>(string search = null, string searchOn = null, string sortBy = null, int page = 1, int pageSize = 20, object filters = null, string accessToken = null) => Request("v1", "catalogs").SetQueryParams(new { search, searchOn, sortBy, page, pageSize }).SetQueryParams(filters).GetJsonAsync<ListPage<Catalog<Txp>>>();
		...
		public Task<Catalog<Txp>> CreateAsync<Txp>(Catalog catalog, string accessToken = null) => Request("v1", "catalogs").PostJsonAsync(ValidateModel(catalog)).ReceiveJson<Catalog<Txp>>();
		...
		public Task<Catalog<Txp>> SaveAsync<Txp>(string catalogID, Catalog catalog, string accessToken = null) => Request("v1", "catalogs", catalogID).PutJsonAsync(ValidateModel(catalog)).ReceiveJson<Catalog<Txp>>();
		...
		public Task<Catalog<Txp>> PatchAsync<Txp>(string catalogID, PartialCatalog partialCatalog, string accessToken = null) => Request("v1", "catalogs", catalogID).PatchJsonAsync(ValidateModel(partialCatalog)).ReceiveJson<Catalog<Txp>>();
	...
	public class CategoriesResource : OrderCloudResource, ICategoriesResource
	{
		...
		public Task<Category<Txp>> GetAsync<Txp>(string catalogID, string categoryID, string accessToken = null) => Request("v1", "catalogs", catalogID, "categories", categoryID).GetJsonAsync<Category<Txp>>();
		...
		public Task<ListPage<Category<Txp>>> ListAsync<Txp>(string catalogID, string depth = "1", string search = null, string searchOn = null, string sortBy = null, int page = 1, int pageSize = 20, object filters = null, string accessToken = null) => Request("v1", "catalogs", catalogID, "categories").SetQueryParams(new { depth, search, searchOn, sortBy, page, pageSize }).SetQueryParams(filters).GetJsonAsync<ListPage<Category<Txp>>>();
		...
		public Task<Category<Txp>> CreateAsync<Txp>(string catalogID, Category category, string accessToken = null) => Request("v1", "catalogs", catalogID, "categories").PostJsonAsync(ValidateModel(category)).ReceiveJson<Category<Txp>>();
		...
		public Task<Category<Txp>> SaveAsync<Txp>(string catalogID, string categoryID, Category category, string accessToken = null) => Request("v1", "catalogs", catalogID, "categories", categoryID).PutJsonAsync(ValidateModel(category)).ReceiveJson<Category<Txp>>();
		...
		public Task<Category<Txp>> PatchAsync<Txp>(string catalogID, string categoryID, PartialCategory partialCategory, string accessToken = null) => Request("v1", "catalogs", catalogID, "categories", categoryID).PatchJsonAsync(ValidateModel(partialCategory)).ReceiveJson<Category<Txp>>();
	...
	public class CostCentersResource : OrderCloudResource, ICostCentersResource
	{
		...
		public Task<CostCenter<Txp>> GetAsync<Txp>(string buyerID, string costCenterID, string accessToken = null) => Request("v1", "buyers", buyerID, "costcenters", costCenterID).GetJsonAsync<CostCenter<Txp>>();
		...
		public Task<ListPage<CostCenter<Txp>>> ListAsync<Txp>(string buyerID, string search = null, string searchOn = null, string sortBy = null, int page = 1, int pageSize = 20, object filters = null, string accessToken = null) => Request("v1", "buyers", buyerID, "costcenters").SetQueryParams(new { search, searchOn, sortBy, page, pageSize }).SetQueryParams(filters).GetJsonAsync<ListPage<CostCenter<Txp>>>();
		...
		public Task<CostCenter<Txp>> CreateAsync<Txp>(string buyerID, CostCenter costCenter, string accessToken = null) => Request("v1", "buyers", buyerID, "costcenters").PostJsonAsync(ValidateModel(costCenter)).ReceiveJson<CostCenter<Txp>>();
		...
		public Task<CostCenter<Txp>> SaveAsync<Txp>(string buyerID, string costCenterID, CostCenter costCenter, string accessToken = null) => Request("v1", "buyers", buyerID, "costcenters", costCenterID).PutJsonAsync(ValidateModel(costCenter)).ReceiveJson<CostCenter<Txp>>();
		...
		public Task<CostCenter<Txp>> PatchAsync<Txp>(string buyerID, string costCenterID, PartialCostCenter partialCostCenter, string accessToken = null) => Request("v1", "buyers", buyerID, "costcenters", costCenterID).PatchJsonAsync(ValidateModel(partialCostCenter)).ReceiveJson<CostCenter<Txp>>();
	...
	public class CreditCardsResource : OrderCloudResource, ICreditCardsResource
	{
		...
		public Task<CreditCard<Txp>> GetAsync<Txp>(string buyerID, string creditCardID, string accessToken = null) => Request("v1", "buyers", buyerID, "creditcards", creditCardID).GetJsonAsync<CreditCard<Txp>>();
		...
		public Task<ListPage<CreditCard<Txp>>> ListAsync<Txp>(string buyerID, string search = null, string searchOn = null, string sortBy = null, int page = 1, int pageSize = 20, object filters = null, string accessToken = null) => Request("v1", "buyers", buyerID, "creditcards").SetQueryParams(new { search, searchOn, sortBy, page, pageSize }).SetQueryParams(filters).GetJsonAsync<ListPage<CreditCard<Txp>>>();
		...
		public Task<CreditCard<Txp>> CreateAsync<Txp>(string buyerID, CreditCard creditCard, string accessToken = null) => Request("v1", "buyers", buyerID, "creditcards").PostJsonAsync(ValidateModel(creditCard)).ReceiveJson<CreditCard<Txp>>();
		...
		public Task<CreditCard<Txp>> SaveAsync<Txp>(string buyerID, string creditCardID, CreditCard creditCard, string accessToken = null) => Request("v1", "buyers", buyerID, "creditcards", creditCardID).PutJsonAsync(ValidateModel(creditCard)).ReceiveJson<CreditCard<Txp>>();
		...
		public Task<CreditCard<Txp>> PatchAsync<Txp>(string buyerID, string creditCardID, PartialCreditCard partialCreditCard, string accessToken = null) => Request("v1", "buyers", buyerID, "creditcards", creditCardID).PatchJsonAsync(ValidateModel(partialCreditCard)).ReceiveJson<CreditCard<Txp>>();
	...
	public class LineItemsResource : OrderCloudResource, ILineItemsResource
	{
		...
		public Task<LineItem<Txp>> GetAsync<Txp>(OrderDirection direction, string orderID, string lineItemID, string accessToken = null) => Request("v1", "orders", direction, orderID, "lineitems", lineItemID).GetJsonAsync<LineItem<Txp>>();
		...
		public Task<ListPage<LineItem<Txp>>> ListAsync<Txp>(OrderDirection direction, string orderID, string search = null, string searchOn = null, string sortBy = null, int page = 1, int pageSize = 20, object filters = null, string accessToken = null) => Request("v1", "orders", direction, orderID, "lineitems").SetQueryParams(new { search, searchOn, sortBy, page, pageSize }).SetQueryParams(filters).GetJsonAsync<ListPage<LineItem<Txp>>>();
		...
		public Task<LineItem<Txp>> CreateAsync<Txp>(OrderDirection direction, string orderID, LineItem lineItem, string accessToken = null) => Request("v1", "orders", direction, orderID, "lineitems").PostJsonAsync(ValidateModel(lineItem)).ReceiveJson<LineItem<Txp>>();
		...
		public Task<LineItem<Txp>> SaveAsync<Txp>(OrderDirection direction, string orderID, string lineItemID, LineItem lineItem, string accessToken = null) => Request("v1", "orders", direction, orderID, "lineitems", lineItemID).PutJsonAsync(ValidateModel(lineItem)).ReceiveJson<LineItem<Txp>>();
		...
		public Task<LineItem<Txp>> PatchAsync<Txp>(OrderDirection direction, string orderID, string lineItemID, PartialLineItem partialLineItem, string accessToken = null) => Request("v1", "orders", direction, orderID, "lineitems", lineItemID).PatchJsonAsync(ValidateModel(partialLineItem)).ReceiveJson<LineItem<Txp>>();
		...
		public Task<LineItem<Txp>> SetShippingAddressAsync<Txp>(OrderDirection direction, string orderID, string lineItemID, Address address, string accessToken = null) => Request("v1", "orders", direction, orderID, "lineitems", lineItemID, "shipto").PutJsonAsync(ValidateModel(address)).ReceiveJson<LineItem<Txp>>();
		...
		public Task<LineItem<Txp>> PatchShippingAddressAsync<Txp>(OrderDirection direction, string orderID, string lineItemID, PartialAddress partialAddress, string accessToken = null) => Request("v1", "orders", direction, orderID, "lineitems", lineItemID, "shipto").PatchJsonAsync(ValidateModel(partialAddress)).ReceiveJson<LineItem<Txp>>();
	}
	...
	public class MeResource : OrderCloudResource, IMeResource
	{
		...
		public Task<MeUser<Txp>> GetAsync<Txp>(string accessToken = null) => Request("v1", "me").GetJsonAsync<MeUser<Txp>>();
		...
		public Task<MeUser<Txp>> SaveAsync<Txp>(MeUser meUser, string accessToken = null) => Request("v1", "me").PutJsonAsync(ValidateModel(meUser)).ReceiveJson<MeUser<Txp>>();
		...
		public Task<MeUser<Txp>> PatchAsync<Txp>(PartialMeUser partialMeUser, string accessToken = null) => Request("v1", "me").PatchJsonAsync(ValidateModel(partialMeUser)).ReceiveJson<MeUser<Txp>>();
		...
		public Task<ListPage<CostCenter<Txp>>> ListCostCentersAsync<Txp>(string search = null, string searchOn = null, string sortBy = null, int page = 1, int pageSize = 20, object filters = null, string accessToken = null) => Request("v1", "me", "costcenters").SetQueryParams(new { search, searchOn, sortBy, page, pageSize }).SetQueryParams(filters).GetJsonAsync<ListPage<CostCenter<Txp>>>();
		...
		public Task<ListPage<UserGroup<Txp>>> ListUserGroupsAsync<Txp>(string search = null, string searchOn = null, string sortBy = null, int page = 1, int pageSize = 20, object filters = null, string accessToken = null) => Request("v1", "me", "usergroups").SetQueryParams(new { search, searchOn, sortBy, page, pageSize }).SetQueryParams(filters).GetJsonAsync<ListPage<UserGroup<Txp>>>();
		...
		public Task<ListPage<BuyerAddress<Txp>>> ListAddressesAsync<Txp>(string search = null, string searchOn = null, string sortBy = null, int page = 1, int pageSize = 20, object filters = null, string accessToken = null) => Request("v1", "me", "addresses").SetQueryParams(new { search, searchOn, sortBy, page, pageSize }).SetQueryParams(filters).GetJsonAsync<ListPage<BuyerAddress<Txp>>>();
		...
		public Task<BuyerAddress<Txp>> CreateAddressAsync<Txp>(BuyerAddress buyerAddress, string accessToken = null) => Request("v1", "me", "addresses").PostJsonAsync(ValidateModel(buyerAddress)).ReceiveJson<BuyerAddress<Txp>>();
		...
		public Task<BuyerAddress<Txp>> GetAddressAsync<Txp>(string addressID, string accessToken = null) => Request("v1", "me", "addresses", addressID).GetJsonAsync<BuyerAddress<Txp>>();
		...
		public Task<BuyerAddress<Txp>> SaveAddressAsync<Txp>(string addressID, BuyerAddress buyerAddress, string accessToken = null) => Request("v1", "me", "addresses", addressID).PutJsonAsync(ValidateModel(buyerAddress)).ReceiveJson<BuyerAddress<Txp>>();
		...
		public Task<BuyerCreditCard<Txp>> CreateCreditCardAsync<Txp>(BuyerCreditCard buyerCreditCard, string accessToken = null) => Request("v1", "me", "creditcards").PostJsonAsync(ValidateModel(buyerCreditCard)).ReceiveJson<BuyerCreditCard<Txp>>();
		...
		public Task<ListPage<BuyerCreditCard<Txp>>> ListCreditCardsAsync<Txp>(string search = null, string searchOn = null, string sortBy = null, int page = 1, int pageSize = 20, object filters = null, string accessToken = null) => Request("v1", "me", "creditcards").SetQueryParams(new { search, searchOn, sortBy, page, pageSize }).SetQueryParams(filters).GetJsonAsync<ListPage<BuyerCreditCard<Txp>>>();
		...
		public Task<BuyerCreditCard<Txp>> GetCreditCardAsync<Txp>(string creditcardID, string accessToken = null) => Request("v1", "me", "creditcards", creditcardID).GetJsonAsync<BuyerCreditCard<Txp>>();
		...
		public Task<BuyerCreditCard<Txp>> SaveCreditCardAsync<Txp>(string creditcardID, BuyerCreditCard buyerCreditCard, string accessToken = null) => Request("v1", "me", "creditcards", creditcardID).PutJsonAsync(ValidateModel(buyerCreditCard)).ReceiveJson<BuyerCreditCard<Txp>>();
		...
		public Task<Category<Txp>> GetCategoryAsync<Txp>(string categoryID, string catalogID, string accessToken = null) => Request("v1", "me", "categories", categoryID).SetQueryParams(new { catalogID }).GetJsonAsync<Category<Txp>>();
		...
		public Task<BuyerProduct<Txp>> GetProductAsync<Txp>(string productID, string accessToken = null) => Request("v1", "me", "products", productID).GetJsonAsync<BuyerProduct<Txp>>();
		...
		public Task<BuyerSpec<Txp>> GetSpecAsync<Txp>(string productID, string specID, string catalogID = null, string accessToken = null) => Request("v1", "me", "products", productID, "specs", specID).SetQueryParams(new { catalogID }).GetJsonAsync<BuyerSpec<Txp>>();
		...
		public Task<ListPage<Order<Txp>>> ListOrdersAsync<Txp>(DateTimeOffset? from = null, DateTimeOffset? to = null, string search = null, string searchOn = null, string sortBy = null, int page = 1, int pageSize = 20, object filters = null, string accessToken = null) => Request("v1", "me", "orders").SetQueryParams(new { from, to, search, searchOn, sortBy, page, pageSize }).SetQueryParams(filters).GetJsonAsync<ListPage<Order<Txp>>>();
		...
		public Task<ListPage<Order<Txp>>> ListApprovableOrdersAsync<Txp>(DateTimeOffset? from = null, DateTimeOffset? to = null, string search = null, string searchOn = null, string sortBy = null, int page = 1, int pageSize = 20, object filters = null, string accessToken = null) => Request("v1", "me", "orders", "approvable").SetQueryParams(new { from, to, search, searchOn, sortBy, page, pageSize }).SetQueryParams(filters).GetJsonAsync<ListPage<Order<Txp>>>();
		...
		public Task<ListPage<Promotion<Txp>>> ListPromotionsAsync<Txp>(string search = null, string searchOn = null, string sortBy = null, int page = 1, int pageSize = 20, object filters = null, string accessToken = null) => Request("v1", "me", "promotions").SetQueryParams(new { search, searchOn, sortBy, page, pageSize }).SetQueryParams(filters).GetJsonAsync<ListPage<Promotion<Txp>>>();
		...
		public Task<Promotion<Txp>> GetPromotionAsync<Txp>(string promotionID, string accessToken = null) => Request("v1", "me", "promotions", promotionID).GetJsonAsync<Promotion<Txp>>();
		...
		public Task<ListPage<SpendingAccount<Txp>>> ListSpendingAccountsAsync<Txp>(string search = null, string searchOn = null, string sortBy = null, int page = 1, int pageSize = 20, object filters = null, string accessToken = null) => Request("v1", "me", "spendingAccounts").SetQueryParams(new { search, searchOn, sortBy, page, pageSize }).SetQueryParams(filters).GetJsonAsync<ListPage<SpendingAccount<Txp>>>();
		...
		public Task<SpendingAccount<Txp>> GetSpendingAccountAsync<Txp>(string spendingAccountID, string accessToken = null) => Request("v1", "me", "spendingaccounts", spendingAccountID).GetJsonAsync<SpendingAccount<Txp>>();
		...
		public Task<ListPage<Shipment<Txp>>> ListShipmentsAsync<Txp>(string orderID = null, string search = null, string searchOn = null, string sortBy = null, int page = 1, int pageSize = 20, object filters = null, string accessToken = null) => Request("v1", "me", "shipments").SetQueryParams(new { orderID, search, searchOn, sortBy, page, pageSize }).SetQueryParams(filters).GetJsonAsync<ListPage<Shipment<Txp>>>();
		...
		public Task<Shipment<Txp>> GetShipmentAsync<Txp>(string shipmentID, string accessToken = null) => Request("v1", "me", "shipments", shipmentID).GetJsonAsync<Shipment<Txp>>();
		...
		public Task<ListPage<ShipmentItem<Txp>>> ListShipmentItemsAsync<Txp>(string shipmentID, string orderID = null, string search = null, string searchOn = null, string sortBy = null, int page = 1, int pageSize = 20, object filters = null, string accessToken = null) => Request("v1", "me", "shipments", shipmentID, "items").SetQueryParams(new { orderID, search, searchOn, sortBy, page, pageSize }).SetQueryParams(filters).GetJsonAsync<ListPage<ShipmentItem<Txp>>>();
		public Task<dynamic> RegisterAsync(MeUser meUser, string anonUserToken, string accessToken = null) => Request("v1", "me", "register").WithOAuthBearerToken(accessToken).SetQueryParams(new { anonUserToken }).PutJsonAsync(ValidateModel(meUser)).ReceiveJson<dynamic>();
		...
		public Task<ListPage<Catalog<Txp>>> ListCatalogsAsync<Txp>(string search = null, string searchOn = null, string sortBy = null, int page = 1, int pageSize = 20, object filters = null, string accessToken = null) => Request("v1", "me", "catalogs").SetQueryParams(new { search, searchOn, sortBy, page, pageSize }).SetQueryParams(filters).GetJsonAsync<ListPage<Catalog<Txp>>>();
		...
		public Task<Catalog<Txp>> GetCatalogAsync<Txp>(string catalogID, string accessToken = null) => Request("v1", "me", "catalogs", catalogID).GetJsonAsync<Catalog<Txp>>();
	}
	...
	public class OrdersResource : OrderCloudResource, IOrdersResource
	{
		...
		public Task<Order<Txp>> GetAsync<Txp>(OrderDirection direction, string orderID, string accessToken = null) => Request("v1", "orders", direction, orderID).GetJsonAsync<Order<Txp>>();
		...
		public Task<ListPage<Order<Txp>>> ListAsync<Txp>(OrderDirection direction, string buyerID = null, string supplierID = null, DateTimeOffset? from = null, DateTimeOffset? to = null, string search = null, string searchOn = null, string sortBy = null, int page = 1, int pageSize = 20, object filters = null, string accessToken = null) => Request("v1", "orders", direction).SetQueryParams(new { buyerID, supplierID, from, to, search, searchOn, sortBy, page, pageSize }).SetQueryParams(filters).GetJsonAsync<ListPage<Order<Txp>>>();
		...
		public Task<Order<Txp>> CreateAsync<Txp>(OrderDirection direction, Order order, string accessToken = null) => Request("v1", "orders", direction).PostJsonAsync(ValidateModel(order)).ReceiveJson<Order<Txp>>();
		...
		public Task<Order<Txp>> SaveAsync<Txp>(OrderDirection direction, string orderID, Order order, string accessToken = null) => Request("v1", "orders", direction, orderID).PutJsonAsync(ValidateModel(order)).ReceiveJson<Order<Txp>>();
		...
		public Task<Order<Txp>> PatchAsync<Txp>(OrderDirection direction, string orderID, PartialOrder partialOrder, string accessToken = null) => Request("v1", "orders", direction, orderID).PatchJsonAsync(ValidateModel(partialOrder)).ReceiveJson<Order<Txp>>();
		...
		public Task<Order<Txp>> SubmitAsync<Txp>(OrderDirection direction, string orderID, string accessToken = null) => Request("v1", "orders", direction, orderID, "submit").PostAsync(null).ReceiveJson<Order<Txp>>();
		...
		public Task<Order<Txp>> ApproveAsync<Txp>(OrderDirection direction, string orderID, OrderApprovalInfo orderApprovalInfo, string accessToken = null) => Request("v1", "orders", direction, orderID, "approve").PostJsonAsync(ValidateModel(orderApprovalInfo)).ReceiveJson<Order<Txp>>();
		...
		public Task<Order<Txp>> DeclineAsync<Txp>(OrderDirection direction, string orderID, OrderApprovalInfo orderApprovalInfo, string accessToken = null) => Request("v1", "orders", direction, orderID, "decline").PostJsonAsync(ValidateModel(orderApprovalInfo)).ReceiveJson<Order<Txp>>();
		...
		public Task<Order<Txp>> CancelAsync<Txp>(OrderDirection direction, string orderID, string accessToken = null) => Request("v1", "orders", direction, orderID, "cancel").PostAsync(null).ReceiveJson<Order<Txp>>();
		...
		public Task<Order<Txp>> ShipAsync<Txp>(OrderDirection direction, string orderID, Shipment shipment, string accessToken = null) => Request("v1", "orders", direction, orderID, "ship").PostJsonAsync(ValidateModel(shipment)).ReceiveJson<Order<Txp>>();
		...
		public Task<Order<Txp>> SetShippingAddressAsync<Txp>(OrderDirection direction, string orderID, Address address, string accessToken = null) => Request("v1", "orders", direction, orderID, "shipto").PutJsonAsync(ValidateModel(address)).ReceiveJson<Order<Txp>>();
		...
		public Task<Order<Txp>> PatchShippingAddressAsync<Txp>(OrderDirection direction, string orderID, PartialAddress partialAddress, string accessToken = null) => Request("v1", "orders", direction, orderID, "shipto").PatchJsonAsync(ValidateModel(partialAddress)).ReceiveJson<Order<Txp>>();
		...
		public Task<Order<Txp>> SetBillingAddressAsync<Txp>(OrderDirection direction, string orderID, Address address, string accessToken = null) => Request("v1", "orders", direction, orderID, "billto").PutJsonAsync(ValidateModel(address)).ReceiveJson<Order<Txp>>();
		...
		public Task<Order<Txp>> PatchBillingAddressAsync<Txp>(OrderDirection direction, string orderID, PartialAddress partialAddress, string accessToken = null) => Request("v1", "orders", direction, orderID, "billto").PatchJsonAsync(ValidateModel(partialAddress)).ReceiveJson<Order<Txp>>();
		...
		public Task<Order<Txp>> PatchFromUserAsync<Txp>(OrderDirection direction, string orderID, PartialUser partialUser, string accessToken = null) => Request("v1", "orders", direction, orderID, "fromuser").PatchJsonAsync(ValidateModel(partialUser)).ReceiveJson<Order<Txp>>();
		...
		public Task<Promotion<Txp>> AddPromotionAsync<Txp>(OrderDirection direction, string orderID, string promoCode, string accessToken = null) => Request("v1", "orders", direction, orderID, "promotions", promoCode).PostAsync(null).ReceiveJson<Promotion<Txp>>();
		...
		public Task<ListPage<OrderPromotion<Txp>>> ListPromotionsAsync<Txp>(OrderDirection direction, string orderID, string search = null, string searchOn = null, string sortBy = null, int page = 1, int pageSize = 20, object filters = null, string accessToken = null) => Request("v1", "orders", direction, orderID, "promotions").SetQueryParams(new { search, searchOn, sortBy, page, pageSize }).SetQueryParams(filters).GetJsonAsync<ListPage<OrderPromotion<Txp>>>();
		...
		public Task<Order<Txp>> RemovePromotionAsync<Txp>(OrderDirection direction, string orderID, string promoCode, string accessToken = null) => Request("v1", "orders", direction, orderID, "promotions", promoCode).DeleteAsync().ReceiveJson<Order<Txp>>();
	}
	...
	public class PaymentsResource : OrderCloudResource, IPaymentsResource
	{
		...
		public Task<Payment<Txp>> GetAsync<Txp>(OrderDirection direction, string orderID, string paymentID, string accessToken = null) => Request("v1", "orders", direction, orderID, "payments", paymentID).GetJsonAsync<Payment<Txp>>();
		...
		public Task<ListPage<Payment<Txp>>> ListAsync<Txp>(OrderDirection direction, string orderID, string search = null, string searchOn = null, string sortBy = null, int page = 1, int pageSize = 20, object filters = null, string accessToken = null) => Request("v1", "orders", direction, orderID, "payments").SetQueryParams(new { search, searchOn, sortBy, page, pageSize }).SetQueryParams(filters).GetJsonAsync<ListPage<Payment<Txp>>>();
		...
		public Task<Payment<Txp>> CreateAsync<Txp>(OrderDirection direction, string orderID, Payment payment, string accessToken = null) => Request("v1", "orders", direction, orderID, "payments").PostJsonAsync(ValidateModel(payment)).ReceiveJson<Payment<Txp>>();
		...
		public Task<Payment<Txp>> PatchAsync<Txp>(OrderDirection direction, string orderID, string paymentID, PartialPayment partialPayment, string accessToken = null) => Request("v1", "orders", direction, orderID, "payments", paymentID).PatchJsonAsync(ValidateModel(partialPayment)).ReceiveJson<Payment<Txp>>();
		...
		public Task<Payment<Txp>> CreateTransactionAsync<Txp>(OrderDirection direction, string orderID, string paymentID, PaymentTransaction paymentTransaction, string accessToken = null) => Request("v1", "orders", direction, orderID, "payments", paymentID, "transactions").PostJsonAsync(ValidateModel(paymentTransaction)).ReceiveJson<Payment<Txp>>();
	...
	public class PriceSchedulesResource : OrderCloudResource, IPriceSchedulesResource
	{
		...
		public Task<PriceSchedule<Txp>> GetAsync<Txp>(string priceScheduleID, string accessToken = null) => Request("v1", "priceschedules", priceScheduleID).GetJsonAsync<PriceSchedule<Txp>>();
		...
		public Task<ListPage<PriceSchedule<Txp>>> ListAsync<Txp>(string search = null, string searchOn = null, string sortBy = null, int page = 1, int pageSize = 20, object filters = null, string accessToken = null) => Request("v1", "priceschedules").SetQueryParams(new { search, searchOn, sortBy, page, pageSize }).SetQueryParams(filters).GetJsonAsync<ListPage<PriceSchedule<Txp>>>();
		...
		public Task<PriceSchedule<Txp>> CreateAsync<Txp>(PriceSchedule priceSchedule, string accessToken = null) => Request("v1", "priceschedules").PostJsonAsync(ValidateModel(priceSchedule)).ReceiveJson<PriceSchedule<Txp>>();
		...
		public Task<PriceSchedule<Txp>> SaveAsync<Txp>(string priceScheduleID, PriceSchedule priceSchedule, string accessToken = null) => Request("v1", "priceschedules", priceScheduleID).PutJsonAsync(ValidateModel(priceSchedule)).ReceiveJson<PriceSchedule<Txp>>();
		...
		public Task<PriceSchedule<Txp>> PatchAsync<Txp>(string priceScheduleID, PartialPriceSchedule partialPriceSchedule, string accessToken = null) => Request("v1", "priceschedules", priceScheduleID).PatchJsonAsync(ValidateModel(partialPriceSchedule)).ReceiveJson<PriceSchedule<Txp>>();
		...
		public Task<PriceSchedule<Txp>> SavePriceBreakAsync<Txp>(string priceScheduleID, PriceBreak priceBreak, string accessToken = null) => Request("v1", "priceschedules", priceScheduleID, "PriceBreaks").PostJsonAsync(ValidateModel(priceBreak)).ReceiveJson<PriceSchedule<Txp>>();
	...
	public class ProductsResource : OrderCloudResource, IProductsResource
	{
		...
		public Task<Product<Txp>> GetAsync<Txp>(string productID, string accessToken = null) => Request("v1", "products", productID).GetJsonAsync<Product<Txp>>();
		...
		public Task<ListPage<Product<Txp>>> ListAsync<Txp>(string catalogID = null, string categoryID = null, string supplierID = null, string search = null, string searchOn = null, string sortBy = null, int page = 1, int pageSize = 20, object filters = null, string accessToken = null) => Request("v1", "products").SetQueryParams(new { catalogID, categoryID, supplierID, search, searchOn, sortBy, page, pageSize }).SetQueryParams(filters).GetJsonAsync<ListPage<Product<Txp>>>();
		...
		public Task<Product<Txp>> CreateAsync<Txp>(Product product, string accessToken = null) => Request("v1", "products").PostJsonAsync(ValidateModel(product)).ReceiveJson<Product<Txp>>();
		...
		public Task<Product<Txp>> SaveAsync<Txp>(string productID, Product product, string accessToken = null) => Request("v1", "products", productID).PutJsonAsync(ValidateModel(product)).ReceiveJson<Product<Txp>>();
		...
		public Task<Product<Txp>> PatchAsync<Txp>(string productID, PartialProduct partialProduct, string accessToken = null) => Request("v1", "products", productID).PatchJsonAsync(ValidateModel(partialProduct)).ReceiveJson<Product<Txp>>();
		...
		public Task<Product<Txp>> GenerateVariantsAsync<Txp>(string productID, bool overwriteExisting = false, string accessToken = null) => Request("v1", "products", productID, "variants", "generate").SetQueryParams(new { overwriteExisting }).PostAsync(null).ReceiveJson<Product<Txp>>();
		...
		public Task<ListPage<Variant<Txp>>> ListVariantsAsync<Txp>(string productID, string search = null, string searchOn = null, string sortBy = null, int page = 1, int pageSize = 20, object filters = null, string accessToken = null) => Request("v1", "products", productID, "variants").SetQueryParams(new { search, searchOn, sortBy, page, pageSize }).SetQueryParams(filters).GetJsonAsync<ListPage<Variant<Txp>>>();
		...
		public Task<Variant<Txp>> SaveVariantAsync<Txp>(string productID, string variantID, Variant variant, string accessToken = null) => Request("v1", "products", productID, "variants", variantID).PutJsonAsync(ValidateModel(variant)).ReceiveJson<Variant<Txp>>();
		...
		public Task<Variant<Txp>> PatchVariantAsync<Txp>(string productID, string variantID, PartialVariant partialVariant, string accessToken = null) => Request("v1", "products", productID, "variants", variantID).PatchJsonAsync(ValidateModel(partialVariant)).ReceiveJson<Variant<Txp>>();
		...
		public Task<Variant<Txp>> GetVariantAsync<Txp>(string productID, string variantID, string accessToken = null) => Request("v1", "products", productID, "variants", variantID).GetJsonAsync<Variant<Txp>>();
		...
		public Task<ListPage<Supplier<Txp>>> ListSuppliersAsync<Txp>(string productID, string search = null, string searchOn = null, string sortBy = null, int page = 1, int pageSize = 20, object filters = null, string accessToken = null) => Request("v1", "products", productID, "suppliers").SetQueryParams(new { search, searchOn, sortBy, page, pageSize }).SetQueryParams(filters).GetJsonAsync<ListPage<Supplier<Txp>>>();
	...
	public class PromotionsResource : OrderCloudResource, IPromotionsResource
	{
		...
		public Task<Promotion<Txp>> GetAsync<Txp>(string promotionID, string accessToken = null) => Request("v1", "promotions", promotionID).GetJsonAsync<Promotion<Txp>>();
		...
		public Task<ListPage<Promotion<Txp>>> ListAsync<Txp>(string search = null, string searchOn = null, string sortBy = null, int page = 1, int pageSize = 20, object filters = null, string accessToken = null) => Request("v1", "promotions").SetQueryParams(new { search, searchOn, sortBy, page, pageSize }).SetQueryParams(filters).GetJsonAsync<ListPage<Promotion<Txp>>>();
		...
		public Task<Promotion<Txp>> CreateAsync<Txp>(Promotion promotion, string accessToken = null) => Request("v1", "promotions").PostJsonAsync(ValidateModel(promotion)).ReceiveJson<Promotion<Txp>>();
		...
		public Task<Promotion<Txp>> SaveAsync<Txp>(string promotionID, Promotion promotion, string accessToken = null) => Request("v1", "promotions", promotionID).PutJsonAsync(ValidateModel(promotion)).ReceiveJson<Promotion<Txp>>();
		...
		public Task<Promotion<Txp>> PatchAsync<Txp>(string promotionID, PartialPromotion partialPromotion, string accessToken = null) => Request("v1", "promotions", promotionID).PatchJsonAsync(ValidateModel(partialPromotion)).ReceiveJson<Promotion<Txp>>();
	...
	public class ShipmentsResource : OrderCloudResource, IShipmentsResource
	{
		...
		public Task<Shipment<Txp>> GetAsync<Txp>(string shipmentID, string accessToken = null) => Request("v1", "shipments", shipmentID).GetJsonAsync<Shipment<Txp>>();
		...
		public Task<ListPage<Shipment<Txp>>> ListAsync<Txp>(string orderID = null, string search = null, string searchOn = null, string sortBy = null, int page = 1, int pageSize = 20, object filters = null, string accessToken = null) => Request("v1", "shipments").SetQueryParams(new { orderID, search, searchOn, sortBy, page, pageSize }).SetQueryParams(filters).GetJsonAsync<ListPage<Shipment<Txp>>>();
		...
		public Task<Shipment<Txp>> CreateAsync<Txp>(Shipment shipment, string accessToken = null) => Request("v1", "shipments").PostJsonAsync(ValidateModel(shipment)).ReceiveJson<Shipment<Txp>>();
		...
		public Task<Shipment<Txp>> SaveAsync<Txp>(string shipmentID, Shipment shipment, string accessToken = null) => Request("v1", "shipments", shipmentID).PutJsonAsync(ValidateModel(shipment)).ReceiveJson<Shipment<Txp>>();
		...
		public Task<Shipment<Txp>> PatchAsync<Txp>(string shipmentID, PartialShipment partialShipment, string accessToken = null) => Request("v1", "shipments", shipmentID).PatchJsonAsync(ValidateModel(partialShipment)).ReceiveJson<Shipment<Txp>>();
		...
		public Task<ListPage<ShipmentItem<Txp>>> ListItemsAsync<Txp>(string shipmentID, string search = null, string searchOn = null, string sortBy = null, int page = 1, int pageSize = 20, object filters = null, string accessToken = null) => Request("v1", "shipments", shipmentID, "items").SetQueryParams(new { search, searchOn, sortBy, page, pageSize }).SetQueryParams(filters).GetJsonAsync<ListPage<ShipmentItem<Txp>>>();
		...
		public Task<ShipmentItem<Txp>> GetItemAsync<Txp>(string shipmentID, string orderID, string lineItemID, string accessToken = null) => Request("v1", "shipments", shipmentID, "items", orderID, lineItemID).GetJsonAsync<ShipmentItem<Txp>>();
		...
		public Task<ShipmentItem<Txp>> SaveItemAsync<Txp>(string shipmentID, ShipmentItem shipmentItem, string accessToken = null) => Request("v1", "shipments", shipmentID, "items").PostJsonAsync(ValidateModel(shipmentItem)).ReceiveJson<ShipmentItem<Txp>>();
	...
	public class SpecsResource : OrderCloudResource, ISpecsResource
	{
		...
		public Task<Spec<Txp>> GetAsync<Txp>(string specID, string accessToken = null) => Request("v1", "specs", specID).GetJsonAsync<Spec<Txp>>();
		...
		public Task<ListPage<Spec<Txp>>> ListAsync<Txp>(string search = null, string searchOn = null, string sortBy = null, int page = 1, int pageSize = 20, object filters = null, string accessToken = null) => Request("v1", "specs").SetQueryParams(new { search, searchOn, sortBy, page, pageSize }).SetQueryParams(filters).GetJsonAsync<ListPage<Spec<Txp>>>();
		...
		public Task<Spec<Txp>> CreateAsync<Txp>(Spec spec, string accessToken = null) => Request("v1", "specs").PostJsonAsync(ValidateModel(spec)).ReceiveJson<Spec<Txp>>();
		...
		public Task<Spec<Txp>> SaveAsync<Txp>(string specID, Spec spec, string accessToken = null) => Request("v1", "specs", specID).PutJsonAsync(ValidateModel(spec)).ReceiveJson<Spec<Txp>>();
		...
		public Task<Spec<Txp>> PatchAsync<Txp>(string specID, PartialSpec partialSpec, string accessToken = null) => Request("v1", "specs", specID).PatchJsonAsync(ValidateModel(partialSpec)).ReceiveJson<Spec<Txp>>();
		...
		public Task<SpecOption<Txp>> CreateOptionAsync<Txp>(string specID, SpecOption specOption, string accessToken = null) => Request("v1", "specs", specID, "options").PostJsonAsync(ValidateModel(specOption)).ReceiveJson<SpecOption<Txp>>();
		...
		public Task<ListPage<SpecOption<Txp>>> ListOptionsAsync<Txp>(string specID, string search = null, string searchOn = null, string sortBy = null, int page = 1, int pageSize = 20, object filters = null, string accessToken = null) => Request("v1", "specs", specID, "options").SetQueryParams(new { search, searchOn, sortBy, page, pageSize }).SetQueryParams(filters).GetJsonAsync<ListPage<SpecOption<Txp>>>();
		...
		public Task<SpecOption<Txp>> SaveOptionAsync<Txp>(string specID, string optionID, SpecOption specOption, string accessToken = null) => Request("v1", "specs", specID, "options", optionID).PutJsonAsync(ValidateModel(specOption)).ReceiveJson<SpecOption<Txp>>();
		...
		public Task<SpecOption<Txp>> PatchOptionAsync<Txp>(string specID, string optionID, PartialSpecOption partialSpecOption, string accessToken = null) => Request("v1", "specs", specID, "options", optionID).PatchJsonAsync(ValidateModel(partialSpecOption)).ReceiveJson<SpecOption<Txp>>();
		...
		public Task<SpecOption<Txp>> GetOptionAsync<Txp>(string specID, string optionID, string accessToken = null) => Request("v1", "specs", specID, "options", optionID).GetJsonAsync<SpecOption<Txp>>();
	...
	public class SpendingAccountsResource : OrderCloudResource, ISpendingAccountsResource
	{
		...
		public Task<SpendingAccount<Txp>> GetAsync<Txp>(string buyerID, string spendingAccountID, string accessToken = null) => Request("v1", "buyers", buyerID, "spendingaccounts", spendingAccountID).GetJsonAsync<SpendingAccount<Txp>>();
		...
		public Task<ListPage<SpendingAccount<Txp>>> ListAsync<Txp>(string buyerID, string search = null, string searchOn = null, string sortBy = null, int page = 1, int pageSize = 20, object filters = null, string accessToken = null) => Request("v1", "buyers", buyerID, "spendingaccounts").SetQueryParams(new { search, searchOn, sortBy, page, pageSize }).SetQueryParams(filters).GetJsonAsync<ListPage<SpendingAccount<Txp>>>();
		...
		public Task<SpendingAccount<Txp>> CreateAsync<Txp>(string buyerID, SpendingAccount spendingAccount, string accessToken = null) => Request("v1", "buyers", buyerID, "spendingaccounts").PostJsonAsync(ValidateModel(spendingAccount)).ReceiveJson<SpendingAccount<Txp>>();
		...
		public Task<SpendingAccount<Txp>> SaveAsync<Txp>(string buyerID, string spendingAccountID, SpendingAccount spendingAccount, string accessToken = null) => Request("v1", "buyers", buyerID, "spendingaccounts", spendingAccountID).PutJsonAsync(ValidateModel(spendingAccount)).ReceiveJson<SpendingAccount<Txp>>();
		...
		public Task<SpendingAccount<Txp>> PatchAsync<Txp>(string buyerID, string spendingAccountID, PartialSpendingAccount partialSpendingAccount, string accessToken = null) => Request("v1", "buyers", buyerID, "spendingaccounts", spendingAccountID).PatchJsonAsync(ValidateModel(partialSpendingAccount)).ReceiveJson<SpendingAccount<Txp>>();
	...
	public class SuppliersResource : OrderCloudResource, ISuppliersResource
	{
		...
		public Task<Supplier<Txp>> GetAsync<Txp>(string supplierID, string accessToken = null) => Request("v1", "suppliers", supplierID).GetJsonAsync<Supplier<Txp>>();
		...
		public Task<ListPage<Supplier<Txp>>> ListAsync<Txp>(string search = null, string searchOn = null, string sortBy = null, int page = 1, int pageSize = 20, object filters = null, string accessToken = null) => Request("v1", "suppliers").SetQueryParams(new { search, searchOn, sortBy, page, pageSize }).SetQueryParams(filters).GetJsonAsync<ListPage<Supplier<Txp>>>();
		...
		public Task<Supplier<Txp>> CreateAsync<Txp>(Supplier supplier, string accessToken = null) => Request("v1", "suppliers").PostJsonAsync(ValidateModel(supplier)).ReceiveJson<Supplier<Txp>>();
		...
		public Task<Supplier<Txp>> SaveAsync<Txp>(string supplierID, Supplier supplier, string accessToken = null) => Request("v1", "suppliers", supplierID).PutJsonAsync(ValidateModel(supplier)).ReceiveJson<Supplier<Txp>>();
		...
		public Task<Supplier<Txp>> PatchAsync<Txp>(string supplierID, PartialSupplier partialSupplier, string accessToken = null) => Request("v1", "suppliers", supplierID).PatchJsonAsync(ValidateModel(partialSupplier)).ReceiveJson<Supplier<Txp>>();
	}
	...
	public class SupplierUserGroupsResource : OrderCloudResource, ISupplierUserGroupsResource
	{
		...
		public Task<UserGroup<Txp>> GetAsync<Txp>(string supplierID, string userGroupID, string accessToken = null) => Request("v1", "suppliers", supplierID, "usergroups", userGroupID).GetJsonAsync<UserGroup<Txp>>();
		...
		public Task<UserGroup<Txp>> CreateAsync<Txp>(string supplierID, UserGroup userGroup, string accessToken = null) => Request("v1", "suppliers", supplierID, "usergroups").PostJsonAsync(ValidateModel(userGroup)).ReceiveJson<UserGroup<Txp>>();
		...
		public Task<UserGroup<Txp>> SaveAsync<Txp>(string supplierID, string userGroupID, UserGroup userGroup, string accessToken = null) => Request("v1", "suppliers", supplierID, "usergroups", userGroupID).PutJsonAsync(ValidateModel(userGroup)).ReceiveJson<UserGroup<Txp>>();
		...
		public Task<UserGroup<Txp>> PatchAsync<Txp>(string supplierID, string userGroupID, PartialUserGroup partialUserGroup, string accessToken = null) => Request("v1", "suppliers", supplierID, "usergroups", userGroupID).PatchJsonAsync(ValidateModel(partialUserGroup)).ReceiveJson<UserGroup<Txp>>();
	...
	public class SupplierUsersResource : OrderCloudResource, ISupplierUsersResource
	{
		...
		public Task<User<Txp>> GetAsync<Txp>(string supplierID, string userID, string accessToken = null) => Request("v1", "suppliers", supplierID, "users", userID).GetJsonAsync<User<Txp>>();
		...
		public Task<User<Txp>> CreateAsync<Txp>(string supplierID, User user, string accessToken = null) => Request("v1", "suppliers", supplierID, "users").PostJsonAsync(ValidateModel(user)).ReceiveJson<User<Txp>>();
		...
		public Task<User<Txp>> SaveAsync<Txp>(string supplierID, string userID, User user, string accessToken = null) => Request("v1", "suppliers", supplierID, "users", userID).PutJsonAsync(ValidateModel(user)).ReceiveJson<User<Txp>>();
		...
		public Task<User<Txp>> PatchAsync<Txp>(string supplierID, string userID, PartialUser partialUser, string accessToken = null) => Request("v1", "suppliers", supplierID, "users", userID).PatchJsonAsync(ValidateModel(partialUser)).ReceiveJson<User<Txp>>();
	...
	public class UserGroupsResource : OrderCloudResource, IUserGroupsResource
	{
		...
		public Task<UserGroup<Txp>> GetAsync<Txp>(string buyerID, string userGroupID, string accessToken = null) => Request("v1", "buyers", buyerID, "usergroups", userGroupID).GetJsonAsync<UserGroup<Txp>>();
		...
		public Task<ListPage<UserGroup<Txp>>> ListAsync<Txp>(string buyerID, string search = null, string searchOn = null, string sortBy = null, int page = 1, int pageSize = 20, object filters = null, string accessToken = null) => Request("v1", "buyers", buyerID, "usergroups").SetQueryParams(new { search, searchOn, sortBy, page, pageSize }).SetQueryParams(filters).GetJsonAsync<ListPage<UserGroup<Txp>>>();
		...
		public Task<UserGroup<Txp>> CreateAsync<Txp>(string buyerID, UserGroup userGroup, string accessToken = null) => Request("v1", "buyers", buyerID, "usergroups").PostJsonAsync(ValidateModel(userGroup)).ReceiveJson<UserGroup<Txp>>();
		...
		public Task<UserGroup<Txp>> SaveAsync<Txp>(string buyerID, string userGroupID, UserGroup userGroup, string accessToken = null) => Request("v1", "buyers", buyerID, "usergroups", userGroupID).PutJsonAsync(ValidateModel(userGroup)).ReceiveJson<UserGroup<Txp>>();
		...
		public Task<UserGroup<Txp>> PatchAsync<Txp>(string buyerID, string userGroupID, PartialUserGroup partialUserGroup, string accessToken = null) => Request("v1", "buyers", buyerID, "usergroups", userGroupID).PatchJsonAsync(ValidateModel(partialUserGroup)).ReceiveJson<UserGroup<Txp>>();
	...
	public class UsersResource : OrderCloudResource, IUsersResource
	{
		...
		public Task<User<Txp>> GetAsync<Txp>(string buyerID, string userID, string accessToken = null) => Request("v1", "buyers", buyerID, "users", userID).GetJsonAsync<User<Txp>>();
		...
		public Task<ListPage<User<Txp>>> ListAsync<Txp>(string buyerID, string userGroupID = null, string search = null, string searchOn = null, string sortBy = null, int page = 1, int pageSize = 20, object filters = null, string accessToken = null) => Request("v1", "buyers", buyerID, "users").SetQueryParams(new { userGroupID, search, searchOn, sortBy, page, pageSize }).SetQueryParams(filters).GetJsonAsync<ListPage<User<Txp>>>();
		...
		public Task<User<Txp>> CreateAsync<Txp>(string buyerID, User user, string accessToken = null) => Request("v1", "buyers", buyerID, "users").PostJsonAsync(ValidateModel(user)).ReceiveJson<User<Txp>>();
		...
		public Task<User<Txp>> SaveAsync<Txp>(string buyerID, string userID, User user, string accessToken = null) => Request("v1", "buyers", buyerID, "users", userID).PutJsonAsync(ValidateModel(user)).ReceiveJson<User<Txp>>();
		...
		public Task<User<Txp>> PatchAsync<Txp>(string buyerID, string userID, PartialUser partialUser, string accessToken = null) => Request("v1", "buyers", buyerID, "users", userID).PatchJsonAsync(ValidateModel(partialUser)).ReceiveJson<User<Txp>>();
		...
		public Task<User<Txp>> MoveAsync<Txp>(string buyerID, string userID, string newBuyerID, UserOrderMoveOption orders, string accessToken = null) => Request("v1", "buyers", buyerID, "users", userID, "moveto", newBuyerID).SetQueryParams(new { orders }).PostAsync(null).ReceiveJson<User<Txp>>();
