...
namespace OrderCloud.SDK
{
	public static class WebhookPayloads
	{
		public static class Addresses
		{
			...
			public class Create : WebhookPayload<Address, Address, Create.RouteParams, dynamic>
			{
			...
			[SentOn("POST", "v1/buyers/{buyerID}/addresses")]
			public class Create<TConfigData> : WebhookPayload<Address, Address, Create.RouteParams, TConfigData> { }
			...
			public class Save : WebhookPayload<Address, Address, Save.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string BuyerID { get; set; }
			...
			[SentOn("PUT", "v1/buyers/{buyerID}/addresses/{addressID}")]
			public class Save<TConfigData> : WebhookPayload<Address, Address, Save.RouteParams, TConfigData> { }
			...
			public class Delete : WebhookPayload<string, string, Delete.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string BuyerID { get; set; }
			...
			[SentOn("DELETE", "v1/buyers/{buyerID}/addresses/{addressID}")]
			public class Delete<TConfigData> : WebhookPayload<string, string, Delete.RouteParams, TConfigData> { }
			...
			public class Patch : WebhookPayload<Address, Address, Patch.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string BuyerID { get; set; }
			...
			[SentOn("PATCH", "v1/buyers/{buyerID}/addresses/{addressID}")]
			public class Patch<TConfigData> : WebhookPayload<Address, Address, Patch.RouteParams, TConfigData> { }
			...
			public class DeleteAssignment : WebhookPayload<string, string, DeleteAssignment.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string BuyerID { get; set; }
			...
			[SentOn("DELETE", "v1/buyers/{buyerID}/addresses/{addressID}/assignments")]
			public class DeleteAssignment<TConfigData> : WebhookPayload<string, string, DeleteAssignment.RouteParams, TConfigData> { }
			...
			public class SaveAssignment : WebhookPayload<AddressAssignment, string, SaveAssignment.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string BuyerID { get; set; }
			...
			[SentOn("POST", "v1/buyers/{buyerID}/addresses/assignments")]
			public class SaveAssignment<TConfigData> : WebhookPayload<AddressAssignment, string, SaveAssignment.RouteParams, TConfigData> { }
		}
		...
		public static class AdminUserGroups
		{
			...
			public class Save : WebhookPayload<UserGroup, UserGroup, Save.RouteParams, dynamic>
			{
				public class RouteParams
				{
			...
			[SentOn("PUT", "v1/usergroups/{userGroupID}")]
			public class Save<TConfigData> : WebhookPayload<UserGroup, UserGroup, Save.RouteParams, TConfigData> { }
			...
			public class Patch : WebhookPayload<UserGroup, UserGroup, Patch.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string UserGroupID { get; set; }
			...
			[SentOn("PATCH", "v1/usergroups/{userGroupID}")]
			public class Patch<TConfigData> : WebhookPayload<UserGroup, UserGroup, Patch.RouteParams, TConfigData> { }
			...
			public class DeleteUserAssignment : WebhookPayload<string, string, DeleteUserAssignment.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string UserGroupID { get; set; }
			...
			[SentOn("DELETE", "v1/usergroups/{userGroupID}/assignments/{userID}")]
			public class DeleteUserAssignment<TConfigData> : WebhookPayload<string, string, DeleteUserAssignment.RouteParams, TConfigData> { }
		...
		public static class AdminUsers
		{
			...
			public class Save : WebhookPayload<User, User, Save.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string UserID { get; set; }
			...
			[SentOn("PUT", "v1/adminusers/{userID}")]
			public class Save<TConfigData> : WebhookPayload<User, User, Save.RouteParams, TConfigData> { }
			...
			public class Patch : WebhookPayload<User, User, Patch.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string UserID { get; set; }
			...
			[SentOn("PATCH", "v1/adminusers/{userID}")]
			public class Patch<TConfigData> : WebhookPayload<User, User, Patch.RouteParams, TConfigData> { }
		}
		public static class ApprovalRules
		{
			...
			public class Create : WebhookPayload<ApprovalRule, ApprovalRule, Create.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string BuyerID { get; set; }
			...
			[SentOn("POST", "v1/buyers/{buyerID}/approvalrules")]
			public class Create<TConfigData> : WebhookPayload<ApprovalRule, ApprovalRule, Create.RouteParams, TConfigData> { }
			...
			public class Save : WebhookPayload<ApprovalRule, ApprovalRule, Save.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string BuyerID { get; set; }
			...
			[SentOn("PUT", "v1/buyers/{buyerID}/approvalrules/{approvalRuleID}")]
			public class Save<TConfigData> : WebhookPayload<ApprovalRule, ApprovalRule, Save.RouteParams, TConfigData> { }
			...
			public class Patch : WebhookPayload<ApprovalRule, ApprovalRule, Patch.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string BuyerID { get; set; }
			...
			[SentOn("PATCH", "v1/buyers/{buyerID}/approvalrules/{approvalRuleID}")]
			public class Patch<TConfigData> : WebhookPayload<ApprovalRule, ApprovalRule, Patch.RouteParams, TConfigData> { }
		}
		public static class Buyers
		{
			...
			public class Save : WebhookPayload<Buyer, Buyer, Save.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string BuyerID { get; set; }
			...
			[SentOn("PUT", "v1/buyers/{buyerID}")]
			public class Save<TConfigData> : WebhookPayload<Buyer, Buyer, Save.RouteParams, TConfigData> { }
			/// <summary>Webhook payload sent by OrderCloud on PATCH v1/buyers/{buyerID}.</summary>
			[SentOn("PATCH", "v1/buyers/{buyerID}")]
			public class Patch : WebhookPayload<Buyer, Buyer, Patch.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string BuyerID { get; set; }
			...
			[SentOn("PATCH", "v1/buyers/{buyerID}")]
			public class Patch<TConfigData> : WebhookPayload<Buyer, Buyer, Patch.RouteParams, TConfigData> { }
		}
		public static class Catalogs
		{
			...
			public class Save : WebhookPayload<Catalog, Catalog, Save.RouteParams, dynamic>
			{
				public class RouteParams
				{
			...
			[SentOn("PUT", "v1/catalogs/{catalogID}")]
			public class Save<TConfigData> : WebhookPayload<Catalog, Catalog, Save.RouteParams, TConfigData> { }
			...
			public class Patch : WebhookPayload<Catalog, Catalog, Patch.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string CatalogID { get; set; }
			...
			[SentOn("PATCH", "v1/catalogs/{catalogID}")]
			public class Patch<TConfigData> : WebhookPayload<Catalog, Catalog, Patch.RouteParams, TConfigData> { }
			...
			public class DeleteProductAssignment : WebhookPayload<string, string, DeleteProductAssignment.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string CatalogID { get; set; }
			...
			[SentOn("DELETE", "v1/catalogs/{catalogID}/productassignments/{productID}")]
			public class DeleteProductAssignment<TConfigData> : WebhookPayload<string, string, DeleteProductAssignment.RouteParams, TConfigData> { }
		}
		public static class Categories
		{
			...
			public class Create : WebhookPayload<Category, Category, Create.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string CatalogID { get; set; }
			...
			[SentOn("POST", "v1/catalogs/{catalogID}/categories")]
			public class Create<TConfigData> : WebhookPayload<Category, Category, Create.RouteParams, TConfigData> { }
			...
			public class Save : WebhookPayload<Category, Category, Save.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string CatalogID { get; set; }
			...
			[SentOn("PUT", "v1/catalogs/{catalogID}/categories/{categoryID}")]
			public class Save<TConfigData> : WebhookPayload<Category, Category, Save.RouteParams, TConfigData> { }
			...
			public class Patch : WebhookPayload<Category, Category, Patch.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string CatalogID { get; set; }
			...
			[SentOn("PATCH", "v1/catalogs/{catalogID}/categories/{categoryID}")]
			public class Patch<TConfigData> : WebhookPayload<Category, Category, Patch.RouteParams, TConfigData> { }
			...
			public class SaveAssignment : WebhookPayload<CategoryAssignment, string, SaveAssignment.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string CatalogID { get; set; }
			...
			[SentOn("POST", "v1/catalogs/{catalogID}/categories/assignments")]
			public class SaveAssignment<TConfigData> : WebhookPayload<CategoryAssignment, string, SaveAssignment.RouteParams, TConfigData> { }
			...
			public class SaveProductAssignment : WebhookPayload<CategoryProductAssignment, string, SaveProductAssignment.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string CatalogID { get; set; }
			...
			[SentOn("POST", "v1/catalogs/{catalogID}/categories/productassignments")]
			public class SaveProductAssignment<TConfigData> : WebhookPayload<CategoryProductAssignment, string, SaveProductAssignment.RouteParams, TConfigData> { }
		...
		public static class CostCenters
		{
			...
			public class Create : WebhookPayload<CostCenter, CostCenter, Create.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string BuyerID { get; set; }
			...
			[SentOn("POST", "v1/buyers/{buyerID}/costcenters")]
			public class Create<TConfigData> : WebhookPayload<CostCenter, CostCenter, Create.RouteParams, TConfigData> { }
			...
			public class Save : WebhookPayload<CostCenter, CostCenter, Save.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string BuyerID { get; set; }
			...
			[SentOn("PUT", "v1/buyers/{buyerID}/costcenters/{costCenterID}")]
			public class Save<TConfigData> : WebhookPayload<CostCenter, CostCenter, Save.RouteParams, TConfigData> { }
			...
			public class Patch : WebhookPayload<CostCenter, CostCenter, Patch.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string BuyerID { get; set; }
			...
			[SentOn("PATCH", "v1/buyers/{buyerID}/costcenters/{costCenterID}")]
			public class Patch<TConfigData> : WebhookPayload<CostCenter, CostCenter, Patch.RouteParams, TConfigData> { }
			...
			public class SaveAssignment : WebhookPayload<CostCenterAssignment, string, SaveAssignment.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string BuyerID { get; set; }
			...
			[SentOn("POST", "v1/buyers/{buyerID}/costcenters/assignments")]
			public class SaveAssignment<TConfigData> : WebhookPayload<CostCenterAssignment, string, SaveAssignment.RouteParams, TConfigData> { }
		}
		public static class CreditCards
		{
			...
			public class Create : WebhookPayload<CreditCard, CreditCard, Create.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string BuyerID { get; set; }
			...
			[SentOn("POST", "v1/buyers/{buyerID}/creditcards")]
			public class Create<TConfigData> : WebhookPayload<CreditCard, CreditCard, Create.RouteParams, TConfigData> { }
			...
			public class Save : WebhookPayload<CreditCard, CreditCard, Save.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string BuyerID { get; set; }
			...
			[SentOn("PUT", "v1/buyers/{buyerID}/creditcards/{creditCardID}")]
			public class Save<TConfigData> : WebhookPayload<CreditCard, CreditCard, Save.RouteParams, TConfigData> { }
			...
			public class Patch : WebhookPayload<CreditCard, CreditCard, Patch.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string BuyerID { get; set; }
			...
			[SentOn("PATCH", "v1/buyers/{buyerID}/creditcards/{creditCardID}")]
			public class Patch<TConfigData> : WebhookPayload<CreditCard, CreditCard, Patch.RouteParams, TConfigData> { }
			...
			public class SaveAssignment : WebhookPayload<CreditCardAssignment, string, SaveAssignment.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string BuyerID { get; set; }
			...
			[SentOn("POST", "v1/buyers/{buyerID}/creditcards/assignments")]
			public class SaveAssignment<TConfigData> : WebhookPayload<CreditCardAssignment, string, SaveAssignment.RouteParams, TConfigData> { }
		...
		public static class ImpersonationConfigs
		{
			...
			public class Save : WebhookPayload<ImpersonationConfig, ImpersonationConfig, Save.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string ImpersonationConfigID { get; set; }
			...
			[SentOn("PUT", "v1/impersonationconfig/{impersonationConfigID}")]
			public class Save<TConfigData> : WebhookPayload<ImpersonationConfig, ImpersonationConfig, Save.RouteParams, TConfigData> { }
			...
			public class Patch : WebhookPayload<ImpersonationConfig, ImpersonationConfig, Patch.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string ImpersonationConfigID { get; set; }
			...
			[SentOn("PATCH", "v1/impersonationconfig/{impersonationConfigID}")]
			public class Patch<TConfigData> : WebhookPayload<ImpersonationConfig, ImpersonationConfig, Patch.RouteParams, TConfigData> { }
		}
		public static class Incrementors
		{
			...
			public class Save : WebhookPayload<Incrementor, Incrementor, Save.RouteParams, dynamic>
			{
				public class RouteParams
				{
			...
			[SentOn("PUT", "v1/incrementors/{incrementorID}")]
			public class Save<TConfigData> : WebhookPayload<Incrementor, Incrementor, Save.RouteParams, TConfigData> { }
			...
			public class Patch : WebhookPayload<Incrementor, Incrementor, Patch.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string IncrementorID { get; set; }
			...
			[SentOn("PATCH", "v1/incrementors/{incrementorID}")]
			public class Patch<TConfigData> : WebhookPayload<Incrementor, Incrementor, Patch.RouteParams, TConfigData> { }
		}
		public static class LineItems
		{
			...
			public class Create : WebhookPayload<LineItem, LineItem, Create.RouteParams, dynamic>
			{
				public class RouteParams
				{
			...
			[SentOn("POST", "v1/orders/{direction}/{orderID}/lineitems")]
			public class Create<TConfigData> : WebhookPayload<LineItem, LineItem, Create.RouteParams, TConfigData> { }
			...
			public class Save : WebhookPayload<LineItem, LineItem, Save.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public OrderDirection Direction { get; set; }
			...
			[SentOn("PUT", "v1/orders/{direction}/{orderID}/lineitems/{lineItemID}")]
			public class Save<TConfigData> : WebhookPayload<LineItem, LineItem, Save.RouteParams, TConfigData> { }
			...
			public class Patch : WebhookPayload<LineItem, LineItem, Patch.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public OrderDirection Direction { get; set; }
			...
			[SentOn("PATCH", "v1/orders/{direction}/{orderID}/lineitems/{lineItemID}")]
			public class Patch<TConfigData> : WebhookPayload<LineItem, LineItem, Patch.RouteParams, TConfigData> { }
			...
			public class SetShippingAddress : WebhookPayload<Address, LineItem, SetShippingAddress.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public OrderDirection Direction { get; set; }
			...
			[SentOn("PUT", "v1/orders/{direction}/{orderID}/lineitems/{lineItemID}/shipto")]
			public class SetShippingAddress<TConfigData> : WebhookPayload<Address, LineItem, SetShippingAddress.RouteParams, TConfigData> { }
			...
			public class PatchShippingAddress : WebhookPayload<Address, LineItem, PatchShippingAddress.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public OrderDirection Direction { get; set; }
			...
			[SentOn("PATCH", "v1/orders/{direction}/{orderID}/lineitems/{lineItemID}/shipto")]
			public class PatchShippingAddress<TConfigData> : WebhookPayload<Address, LineItem, PatchShippingAddress.RouteParams, TConfigData> { }
		}
		public static class Me
		{
			...
			public class SaveAddress : WebhookPayload<BuyerAddress, BuyerAddress, SaveAddress.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string AddressID { get; set; }
			...
			[SentOn("PUT", "v1/me/addresses/{addressID}")]
			public class SaveAddress<TConfigData> : WebhookPayload<BuyerAddress, BuyerAddress, SaveAddress.RouteParams, TConfigData> { }
			...
			public class PatchAddress : WebhookPayload<BuyerAddress, string, PatchAddress.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string AddressID { get; set; }
			...
			[SentOn("PATCH", "v1/me/addresses/{addressID}")]
			public class PatchAddress<TConfigData> : WebhookPayload<BuyerAddress, string, PatchAddress.RouteParams, TConfigData> { }
			...
			public class DeleteAddress : WebhookPayload<string, string, DeleteAddress.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string AddressID { get; set; }
			...
			[SentOn("DELETE", "v1/me/addresses/{addressID}")]
			public class DeleteAddress<TConfigData> : WebhookPayload<string, string, DeleteAddress.RouteParams, TConfigData> { }
			...
			public class SaveCreditCard : WebhookPayload<BuyerCreditCard, BuyerCreditCard, SaveCreditCard.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string CreditcardID { get; set; }
			...
			[SentOn("PUT", "v1/me/creditcards/{creditcardID}")]
			public class SaveCreditCard<TConfigData> : WebhookPayload<BuyerCreditCard, BuyerCreditCard, SaveCreditCard.RouteParams, TConfigData> { }
			...
			public class PatchCreditCard : WebhookPayload<BuyerCreditCard, string, PatchCreditCard.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string CreditcardID { get; set; }
			...
			[SentOn("PATCH", "v1/me/creditcards/{creditcardID}")]
			public class PatchCreditCard<TConfigData> : WebhookPayload<BuyerCreditCard, string, PatchCreditCard.RouteParams, TConfigData> { }
			...
			public class DeleteCreditCard : WebhookPayload<string, string, DeleteCreditCard.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string CreditcardID { get; set; }
			...
			[SentOn("DELETE", "v1/me/creditcards/{creditcardID}")]
			public class DeleteCreditCard<TConfigData> : WebhookPayload<string, string, DeleteCreditCard.RouteParams, TConfigData> { }
		...
		public static class Orders
		{
			...
			public class Create : WebhookPayload<Order, Order, Create.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public OrderDirection Direction { get; set; }
			...
			[SentOn("POST", "v1/orders/{direction}")]
			public class Create<TConfigData> : WebhookPayload<Order, Order, Create.RouteParams, TConfigData> { }
			...
			public class Save : WebhookPayload<Order, Order, Save.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public OrderDirection Direction { get; set; }
			...
			[SentOn("PUT", "v1/orders/{direction}/{orderID}")]
			public class Save<TConfigData> : WebhookPayload<Order, Order, Save.RouteParams, TConfigData> { }
			...
			public class Patch : WebhookPayload<Order, Order, Patch.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public OrderDirection Direction { get; set; }
			...
			[SentOn("PATCH", "v1/orders/{direction}/{orderID}")]
			public class Patch<TConfigData> : WebhookPayload<Order, Order, Patch.RouteParams, TConfigData> { }
			...
			public class Submit : WebhookPayload<string, Order, Submit.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public OrderDirection Direction { get; set; }
			...
			[SentOn("POST", "v1/orders/{direction}/{orderID}/submit")]
			public class Submit<TConfigData> : WebhookPayload<string, Order, Submit.RouteParams, TConfigData> { }
			...
			public class Approve : WebhookPayload<OrderApprovalInfo, Order, Approve.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public OrderDirection Direction { get; set; }
			...
			[SentOn("POST", "v1/orders/{direction}/{orderID}/approve")]
			public class Approve<TConfigData> : WebhookPayload<OrderApprovalInfo, Order, Approve.RouteParams, TConfigData> { }
			...
			public class Decline : WebhookPayload<OrderApprovalInfo, Order, Decline.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public OrderDirection Direction { get; set; }
			...
			[SentOn("POST", "v1/orders/{direction}/{orderID}/decline")]
			public class Decline<TConfigData> : WebhookPayload<OrderApprovalInfo, Order, Decline.RouteParams, TConfigData> { }
			...
			public class Cancel : WebhookPayload<string, Order, Cancel.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public OrderDirection Direction { get; set; }
			...
			[SentOn("POST", "v1/orders/{direction}/{orderID}/cancel")]
			public class Cancel<TConfigData> : WebhookPayload<string, Order, Cancel.RouteParams, TConfigData> { }
			...
			public class Ship : WebhookPayload<Shipment, Order, Ship.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public OrderDirection Direction { get; set; }
			...
			[SentOn("POST", "v1/orders/{direction}/{orderID}/ship")]
			public class Ship<TConfigData> : WebhookPayload<Shipment, Order, Ship.RouteParams, TConfigData> { }
			...
			public class SetShippingAddress : WebhookPayload<Address, Order, SetShippingAddress.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public OrderDirection Direction { get; set; }
			...
			[SentOn("PUT", "v1/orders/{direction}/{orderID}/shipto")]
			public class SetShippingAddress<TConfigData> : WebhookPayload<Address, Order, SetShippingAddress.RouteParams, TConfigData> { }
			...
			public class PatchShippingAddress : WebhookPayload<Address, Order, PatchShippingAddress.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public OrderDirection Direction { get; set; }
			...
			[SentOn("PATCH", "v1/orders/{direction}/{orderID}/shipto")]
			public class PatchShippingAddress<TConfigData> : WebhookPayload<Address, Order, PatchShippingAddress.RouteParams, TConfigData> { }
			...
			public class SetBillingAddress : WebhookPayload<Address, Order, SetBillingAddress.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public OrderDirection Direction { get; set; }
			...
			[SentOn("PUT", "v1/orders/{direction}/{orderID}/billto")]
			public class SetBillingAddress<TConfigData> : WebhookPayload<Address, Order, SetBillingAddress.RouteParams, TConfigData> { }
			...
			public class PatchBillingAddress : WebhookPayload<Address, Order, PatchBillingAddress.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public OrderDirection Direction { get; set; }
			...
			[SentOn("PATCH", "v1/orders/{direction}/{orderID}/billto")]
			public class PatchBillingAddress<TConfigData> : WebhookPayload<Address, Order, PatchBillingAddress.RouteParams, TConfigData> { }
			...
			public class PatchFromUser : WebhookPayload<User, Order, PatchFromUser.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public OrderDirection Direction { get; set; }
			...
			[SentOn("PATCH", "v1/orders/{direction}/{orderID}/fromuser")]
			public class PatchFromUser<TConfigData> : WebhookPayload<User, Order, PatchFromUser.RouteParams, TConfigData> { }
			...
			public class AddPromotion : WebhookPayload<string, Promotion, AddPromotion.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public OrderDirection Direction { get; set; }
			...
			[SentOn("POST", "v1/orders/{direction}/{orderID}/promotions/{promoCode}")]
			public class AddPromotion<TConfigData> : WebhookPayload<string, Promotion, AddPromotion.RouteParams, TConfigData> { }
			...
			public class RemovePromotion : WebhookPayload<string, Order, RemovePromotion.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public OrderDirection Direction { get; set; }
			...
			[SentOn("DELETE", "v1/orders/{direction}/{orderID}/promotions/{promoCode}")]
			public class RemovePromotion<TConfigData> : WebhookPayload<string, Order, RemovePromotion.RouteParams, TConfigData> { }
		}
		public static class PasswordResets
		{
			...
			public class ResetPasswordByVerificationCode : WebhookPayload<PasswordReset, string, ResetPasswordByVerificationCode.RouteParams, dynamic>
			{
				public class RouteParams
				{
			...
			[SentOn("PUT", "v1/password/reset/{verificationCode}")]
			public class ResetPasswordByVerificationCode<TConfigData> : WebhookPayload<PasswordReset, string, ResetPasswordByVerificationCode.RouteParams, TConfigData> { }
		}
		public static class Payments
		{
			...
			public class Create : WebhookPayload<Payment, Payment, Create.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public OrderDirection Direction { get; set; }
			...
			[SentOn("POST", "v1/orders/{direction}/{orderID}/payments")]
			public class Create<TConfigData> : WebhookPayload<Payment, Payment, Create.RouteParams, TConfigData> { }
			...
			public class Patch : WebhookPayload<Payment, Payment, Patch.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public OrderDirection Direction { get; set; }
			...
			[SentOn("PATCH", "v1/orders/{direction}/{orderID}/payments/{paymentID}")]
			public class Patch<TConfigData> : WebhookPayload<Payment, Payment, Patch.RouteParams, TConfigData> { }
			...
			public class CreateTransaction : WebhookPayload<PaymentTransaction, Payment, CreateTransaction.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public OrderDirection Direction { get; set; }
			...
			[SentOn("POST", "v1/orders/{direction}/{orderID}/payments/{paymentID}/transactions")]
			public class CreateTransaction<TConfigData> : WebhookPayload<PaymentTransaction, Payment, CreateTransaction.RouteParams, TConfigData> { }
			...
			public class DeleteTransaction : WebhookPayload<string, string, DeleteTransaction.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public OrderDirection Direction { get; set; }
			...
			[SentOn("DELETE", "v1/orders/{direction}/{orderID}/payments/{paymentID}/transactions/{transactionID}")]
			public class DeleteTransaction<TConfigData> : WebhookPayload<string, string, DeleteTransaction.RouteParams, TConfigData> { }
		}
		public static class PriceSchedules
		{
			...
			public class Save : WebhookPayload<PriceSchedule, PriceSchedule, Save.RouteParams, dynamic>
			{
				public class RouteParams
				{
			...
			[SentOn("PUT", "v1/priceschedules/{priceScheduleID}")]
			public class Save<TConfigData> : WebhookPayload<PriceSchedule, PriceSchedule, Save.RouteParams, TConfigData> { }
			...
			public class Patch : WebhookPayload<PriceSchedule, PriceSchedule, Patch.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string PriceScheduleID { get; set; }
			...
			[SentOn("PATCH", "v1/priceschedules/{priceScheduleID}")]
			public class Patch<TConfigData> : WebhookPayload<PriceSchedule, PriceSchedule, Patch.RouteParams, TConfigData> { }
			...
			public class SavePriceBreak : WebhookPayload<PriceBreak, PriceSchedule, SavePriceBreak.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string PriceScheduleID { get; set; }
			...
			[SentOn("POST", "v1/priceschedules/{priceScheduleID}/PriceBreaks")]
			public class SavePriceBreak<TConfigData> : WebhookPayload<PriceBreak, PriceSchedule, SavePriceBreak.RouteParams, TConfigData> { }
			...
			public class DeletePriceBreak : WebhookPayload<string, string, DeletePriceBreak.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string PriceScheduleID { get; set; }
			...
			[SentOn("DELETE", "v1/priceschedules/{priceScheduleID}/PriceBreaks")]
			public class DeletePriceBreak<TConfigData> : WebhookPayload<string, string, DeletePriceBreak.RouteParams, TConfigData> { }
		}
		public static class Products
		{
			...
			public class Save : WebhookPayload<Product, Product, Save.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string ProductID { get; set; }
			...
			[SentOn("PUT", "v1/products/{productID}")]
			public class Save<TConfigData> : WebhookPayload<Product, Product, Save.RouteParams, TConfigData> { }
			...
			public class Patch : WebhookPayload<Product, Product, Patch.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string ProductID { get; set; }
			...
			[SentOn("PATCH", "v1/products/{productID}")]
			public class Patch<TConfigData> : WebhookPayload<Product, Product, Patch.RouteParams, TConfigData> { }
			...
			public class GenerateVariants : WebhookPayload<string, Product, GenerateVariants.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string ProductID { get; set; }
			...
			[SentOn("POST", "v1/products/{productID}/variants/generate")]
			public class GenerateVariants<TConfigData> : WebhookPayload<string, Product, GenerateVariants.RouteParams, TConfigData> { }
			...
			public class SaveVariant : WebhookPayload<Variant, Variant, SaveVariant.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string ProductID { get; set; }
			...
			[SentOn("PUT", "v1/products/{productID}/variants/{variantID}")]
			public class SaveVariant<TConfigData> : WebhookPayload<Variant, Variant, SaveVariant.RouteParams, TConfigData> { }
			...
			public class PatchVariant : WebhookPayload<Variant, Variant, PatchVariant.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string ProductID { get; set; }
			...
			[SentOn("PATCH", "v1/products/{productID}/variants/{variantID}")]
			public class PatchVariant<TConfigData> : WebhookPayload<Variant, Variant, PatchVariant.RouteParams, TConfigData> { }
			...
			public class SaveSupplier : WebhookPayload<string, string, SaveSupplier.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string ProductID { get; set; }
			...
			[SentOn("PUT", "v1/products/{productID}/suppliers/{supplierID}")]
			public class SaveSupplier<TConfigData> : WebhookPayload<string, string, SaveSupplier.RouteParams, TConfigData> { }
			...
			public class RemoveSupplier : WebhookPayload<string, string, RemoveSupplier.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string ProductID { get; set; }
			...
			[SentOn("DELETE", "v1/products/{productID}/suppliers/{supplierID}")]
			public class RemoveSupplier<TConfigData> : WebhookPayload<string, string, RemoveSupplier.RouteParams, TConfigData> { }
		...
		public static class Promotions
		{
			...
			public class Save : WebhookPayload<Promotion, Promotion, Save.RouteParams, dynamic>
			{
				public class RouteParams
				{
			...
			[SentOn("PUT", "v1/promotions/{promotionID}")]
			public class Save<TConfigData> : WebhookPayload<Promotion, Promotion, Save.RouteParams, TConfigData> { }
			...
			public class Patch : WebhookPayload<Promotion, Promotion, Patch.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string PromotionID { get; set; }
			...
			[SentOn("PATCH", "v1/promotions/{promotionID}")]
			public class Patch<TConfigData> : WebhookPayload<Promotion, Promotion, Patch.RouteParams, TConfigData> { }
		...
		public static class Shipments
		{
			...
			public class Save : WebhookPayload<Shipment, Shipment, Save.RouteParams, dynamic>
			{
				public class RouteParams
				{
			...
			[SentOn("PUT", "v1/shipments/{shipmentID}")]
			public class Save<TConfigData> : WebhookPayload<Shipment, Shipment, Save.RouteParams, TConfigData> { }
			...
			public class Patch : WebhookPayload<Shipment, Shipment, Patch.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string ShipmentID { get; set; }
			...
			[SentOn("PATCH", "v1/shipments/{shipmentID}")]
			public class Patch<TConfigData> : WebhookPayload<Shipment, Shipment, Patch.RouteParams, TConfigData> { }
			...
			public class SaveItem : WebhookPayload<ShipmentItem, ShipmentItem, SaveItem.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string ShipmentID { get; set; }
			...
			[SentOn("POST", "v1/shipments/{shipmentID}/items")]
			public class SaveItem<TConfigData> : WebhookPayload<ShipmentItem, ShipmentItem, SaveItem.RouteParams, TConfigData> { }
			...
			public class DeleteItem : WebhookPayload<string, string, DeleteItem.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string ShipmentID { get; set; }
			...
			[SentOn("DELETE", "v1/shipments/{shipmentID}/items/{orderID}/{lineItemID}")]
			public class DeleteItem<TConfigData> : WebhookPayload<string, string, DeleteItem.RouteParams, TConfigData> { }
		}
		public static class Specs
		{
			...
			public class Save : WebhookPayload<Spec, Spec, Save.RouteParams, dynamic>
			{
				public class RouteParams
				{
			...
			[SentOn("PUT", "v1/specs/{specID}")]
			public class Save<TConfigData> : WebhookPayload<Spec, Spec, Save.RouteParams, TConfigData> { }
			...
			public class Patch : WebhookPayload<Spec, Spec, Patch.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string SpecID { get; set; }
			...
			[SentOn("PATCH", "v1/specs/{specID}")]
			public class Patch<TConfigData> : WebhookPayload<Spec, Spec, Patch.RouteParams, TConfigData> { }
			...
			public class CreateOption : WebhookPayload<SpecOption, SpecOption, CreateOption.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string SpecID { get; set; }
			...
			[SentOn("POST", "v1/specs/{specID}/options")]
			public class CreateOption<TConfigData> : WebhookPayload<SpecOption, SpecOption, CreateOption.RouteParams, TConfigData> { }
			...
			public class SaveOption : WebhookPayload<SpecOption, SpecOption, SaveOption.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string SpecID { get; set; }
			...
			[SentOn("PUT", "v1/specs/{specID}/options/{optionID}")]
			public class SaveOption<TConfigData> : WebhookPayload<SpecOption, SpecOption, SaveOption.RouteParams, TConfigData> { }
			...
			public class PatchOption : WebhookPayload<SpecOption, SpecOption, PatchOption.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string SpecID { get; set; }
			...
			[SentOn("PATCH", "v1/specs/{specID}/options/{optionID}")]
			public class PatchOption<TConfigData> : WebhookPayload<SpecOption, SpecOption, PatchOption.RouteParams, TConfigData> { }
			...
			public class DeleteOption : WebhookPayload<string, string, DeleteOption.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string SpecID { get; set; }
			...
			[SentOn("DELETE", "v1/specs/{specID}/options/{optionID}")]
			public class DeleteOption<TConfigData> : WebhookPayload<string, string, DeleteOption.RouteParams, TConfigData> { }
		}
		public static class SpendingAccounts
		{
			...
			public class Create : WebhookPayload<SpendingAccount, SpendingAccount, Create.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string BuyerID { get; set; }
			...
			[SentOn("POST", "v1/buyers/{buyerID}/spendingaccounts")]
			public class Create<TConfigData> : WebhookPayload<SpendingAccount, SpendingAccount, Create.RouteParams, TConfigData> { }
			...
			public class Save : WebhookPayload<SpendingAccount, SpendingAccount, Save.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string BuyerID { get; set; }
			...
			[SentOn("PUT", "v1/buyers/{buyerID}/spendingaccounts/{spendingAccountID}")]
			public class Save<TConfigData> : WebhookPayload<SpendingAccount, SpendingAccount, Save.RouteParams, TConfigData> { }
			...
			public class Patch : WebhookPayload<SpendingAccount, SpendingAccount, Patch.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string BuyerID { get; set; }
			...
			[SentOn("PATCH", "v1/buyers/{buyerID}/spendingaccounts/{spendingAccountID}")]
			public class Patch<TConfigData> : WebhookPayload<SpendingAccount, SpendingAccount, Patch.RouteParams, TConfigData> { }
			...
			public class SaveAssignment : WebhookPayload<SpendingAccountAssignment, string, SaveAssignment.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string BuyerID { get; set; }
			...
			[SentOn("POST", "v1/buyers/{buyerID}/spendingaccounts/assignments")]
			public class SaveAssignment<TConfigData> : WebhookPayload<SpendingAccountAssignment, string, SaveAssignment.RouteParams, TConfigData> { }
		...
		public static class Suppliers
		{
			...
			public class Save : WebhookPayload<Supplier, Supplier, Save.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string SupplierID { get; set; }
			...
			[SentOn("PUT", "v1/suppliers/{supplierID}")]
			public class Save<TConfigData> : WebhookPayload<Supplier, Supplier, Save.RouteParams, TConfigData> { }
			/// <summary>Webhook payload sent by OrderCloud on PATCH v1/suppliers/{supplierID}.</summary>
			[SentOn("PATCH", "v1/suppliers/{supplierID}")]
			public class Patch : WebhookPayload<Supplier, Supplier, Patch.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string SupplierID { get; set; }
			...
			[SentOn("PATCH", "v1/suppliers/{supplierID}")]
			public class Patch<TConfigData> : WebhookPayload<Supplier, Supplier, Patch.RouteParams, TConfigData> { }
		}
		public static class SupplierUserGroups
		{
			...
			public class Create : WebhookPayload<UserGroup, UserGroup, Create.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string SupplierID { get; set; }
			...
			[SentOn("POST", "v1/suppliers/{supplierID}/usergroups")]
			public class Create<TConfigData> : WebhookPayload<UserGroup, UserGroup, Create.RouteParams, TConfigData> { }
			...
			public class SaveUserAssignment : WebhookPayload<UserGroupAssignment, string, SaveUserAssignment.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string SupplierID { get; set; }
			...
			[SentOn("POST", "v1/suppliers/{supplierID}/usergroups/assignments")]
			public class SaveUserAssignment<TConfigData> : WebhookPayload<UserGroupAssignment, string, SaveUserAssignment.RouteParams, TConfigData> { }
		}
		public static class SupplierUsers
		{
			...
			public class Create : WebhookPayload<User, User, Create.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string SupplierID { get; set; }
			...
			[SentOn("POST", "v1/suppliers/{supplierID}/users")]
			public class Create<TConfigData> : WebhookPayload<User, User, Create.RouteParams, TConfigData> { }
			...
			public class GetAccessToken : WebhookPayload<ImpersonateTokenRequest, AccessToken, GetAccessToken.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string SupplierID { get; set; }
			...
			[SentOn("POST", "v1/suppliers/{supplierID}/users/{userID}/accesstoken")]
			public class GetAccessToken<TConfigData> : WebhookPayload<ImpersonateTokenRequest, AccessToken, GetAccessToken.RouteParams, TConfigData> { }
		}
		...
		public static class Users
		{
			...
			public class Move : WebhookPayload<string, User, Move.RouteParams, dynamic>
			{
				public class RouteParams
				{
					public string BuyerID { get; set; }
			...
			[SentOn("POST", "v1/buyers/{buyerID}/users/{userID}/moveto/{newBuyerID}")]
			public class Move<TConfigData> : WebhookPayload<string, User, Move.RouteParams, TConfigData> { }
